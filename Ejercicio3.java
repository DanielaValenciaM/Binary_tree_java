...
//Importamos libreria para tomar datos por pantalla
import javax.swing.*;
import java.util.*;
...
public class Ejercicio3 {
	...
	public static void main(String[] args) {
		...
		System.out.println("El peso del arbol es:"+" "+(raiz.peso()+izq.peso()+der.peso()+izqhijo1.peso()+izqhijo2.peso()+derhijo1.peso()+derhijo2.peso()+izqnieto1.peso()+izqnieto2.peso()+dernieto1.peso()+izqbisnieto1.peso()+derbisnieto1.peso()+derbisnieto2.peso()));//Se invoca el método peso para obtener el peso del sexto nivel del arbol
